...
export const SERVICES: Service[] = [
  ...
  // ───────────── 경북 (보강) ─────────────
  {
    id: "gyeongbuk-haengbok-taxi",
    name: "경북형 행복택시",
    category: "drt",
    sido: "gyeongbuk",
    summary: "버스 안 다니는 마을에서 1,000원에 부르는 택시",
    description:
      "버스가 자주 다니지 않는 경북 농촌 마을 주민을 위한 수요응답형 택시입니다. 1회 1,000원만 내면 면 소재지나 읍내 병원·시장까지 데려다주고, 가구별로 분기마다 탑승권이 제공됩니다. 시·군이 전화 호출과 DRT 앱을 함께 운영해 점차 확대되고 있습니다.",
    howTo: "대상 마을 주민으로 등록 후 콜센터 전화 또는 DRT 앱으로 호출(1회 1,000원)",
  ...
  // ───────────── 제주 (보강) ─────────────
  {
    id: "jeju-haengbok-taxi",
    name: "제주 마을 행복택시",
    category: "drt",
    sido: "jeju",
    summary: "버스 안 들어오는 중산간 마을의 호출 택시",
    description:
      "버스 노선이 닿지 않거나 운행이 뜸한 제주 중산간·농어촌 마을 주민을 위한 수요응답형 택시입니다. 가까운 버스정류장이나 마을 중심지까지 적은 요금으로 데려다줘, 병원·장보기 같은 일상 이동의 교통 사각지대를 메웁니다.",
    howTo: "대상 마을 주민으로 등록 후 지정 콜센터로 전화 호출",
    url: "https://www.jeju.go.kr",
    tags: ["행복택시", "중산간", "농어촌교통", "교통복지"],
  },
];
